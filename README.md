...
### Executive Summary — KPIs & Risk Classification
![KPI Summary](Preview_KPI_Summary.jpg)

### Reconciliation Master — Automated Cross-Validation
![Reconciliation Master](Preview_Reconciliation_Master.jpg)

### Exception Report — Missing, Mismatched & Risk Transactions
![Exception Report](Preview_Exception_Report.jpg)

### System Overview — From Messy Data to Automated Analysis
![System Overview](Preview_System_Overview.jpg)

---

## ⚠️ Data Disclaimer
The dataset used in this project was synthetically generated for 
portfolio purposes using AI-simulated financial data. All ETL logic, 
Power Query architecture, reconciliation rules, exception classification, 
and reporting design were independently developed.
